...
local t = Def.ActorFrame{
	Def.ActorFrame{
		LoadActor("icon_decide1")..{
			InitCommand=cmd(x,22;y,-6;);
			OffCommand=cmd(linear,0.1;diffusealpha,0);
			GainFocusCommand=cmd(finishtweening;diffusealpha,1;cropright,0;cropleft,1;sleep,0.1;linear,0.2;cropleft,0;);
			LoseFocusCommand=cmd(finishtweening;cropleft,0;cropright,0;sleep,0.1;accelerate,0.1;cropright,1;diffusealpha,0;);
		};
	...
	Def.ActorFrame{
		...
		LoadActor(THEME:GetPathG("","stylemodeback/icon_decide2"))..{
			InitCommand=cmd(x,-23;y,42;zoomx,-1;);
			OffCommand=cmd(linear,0.1;diffusealpha,0);
