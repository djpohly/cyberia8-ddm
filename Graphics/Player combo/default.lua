...
local t = Def.ActorFrame {
	...
	ComboCommand=function(self, param)
		...
		if param.Combo and lsatWorstJudge[p] == 1 then
			(cmd(stopeffect;diffuseshift;effectperiod,1;effectcolor1,color("0.7,0.7,1,1");effectcolor2,color("1,1,1,1");strokecolor,color("0.5,0.5,0.5,1")))(cf.Number);
		...
		elseif param.Combo then
			(cmd(stopeffect;diffuse,color("1,1,1,1");strokecolor,color("0.5,0.5,0.5,0")))(cf.Number);
		else
