...
elseif GetScreenAspectRatio() >= 1.77777777777777 then
	bvisible = true;
end;
...
t[#t+1] = Def.ActorFrame{
	...
	Def.Quad{
		InitCommand=cmd(visible,bvisible;horizalign,right;x,SCREEN_RIGHT;y,SCREEN_CENTER_Y;zoomtowidth,bwidth;zoomtoheight,SCREEN_HEIGHT;faderleft,0.2);
