...
t[#t+1] = Def.ActorFrame {
	...
	LoadActor( "01_circle" )..{
		...
		OnCommand=cmd(diffuse,color("0,1,0,1");diffusealpha,0;sleep,15;zoom,1.4;linear,0.2;diffusealpha,1;linear,0.6;zoom,1;linear,0.6;zoom,1.4;linear,0.6;zoom,1;linear,0.6;diffusealpha,0;zoom,1.4);
	};
	...
	LoadActor( "01_circle" )..{
		...
		OnCommand=cmd(diffuse,color("0,1,0,1");diffusealpha,0;sleep,20.15;zoom,2.5;linear,0.1;zoom,1.2;diffusealpha,0.8;sleep,2;linear,0.2;diffusealpha,0;);
	};
	...
	LoadActor( "01_circle" )..{
		InitCommand=cmd(x,-32;);
		OnCommand=cmd(diffuse,color("0,1,0,1");diffusealpha,0;sleep,23.35;zoom,2.5;linear,0.1;zoom,1.2;diffusealpha,0.8;sleep,2;linear,0.2;diffusealpha,0;);
	};
	...
	LoadActor( "01_circle" )..{
		InitCommand=cmd(x,32;);
		OnCommand=cmd(diffuse,color("1,0,1,1");diffusealpha,0;sleep,29.5;zoom,1.4;linear,0.2;diffusealpha,0.8;linear,0.6;zoom,1;
	...
	LoadActor( "c_mine" )..{
		...
		OnCommand=cmd(diffusealpha,0;sleep,33;linear,0.2;diffusealpha,1;sleep,1.8;linear,0.6;diffusealpha,0;zoomy,0);
	};
	--life
	Def.ActorFrame {
		InitCommand=cmd(x,24;y,-63;diffuse,color("1,0,0,1"););
		OnCommand=cmd(zoom,1.2;sleep,38;linear,0.6;zoom,1;linear,0.6;zoom,1.2;linear,0.6;zoom,1;linear,0.6;zoom,1.2;);

		LoadActor( "life_circle_half" )..{
			InitCommand=cmd(x,-(meterwidth/2););
			OnCommand=cmd(diffusealpha,0;sleep,38;linear,0.2;diffusealpha,0.8;linear,2.2;linear,0.2;diffusealpha,0;);
		};
	...
	LoadActor( "danger" )..{
		...
		OnCommand=cmd(diffuse,color("1,0,0,0");sleep,39;linear,0.5;diffuse,color("1,0,0,1");linear,0.5;diffuse,color("1,0.5,0,0.3");linear,0.5;
...
t[#t+1] = Def.ActorFrame {
	...
	LoadActor( "minesmessage" )..{
		OnCommand=cmd(horizalign,left;diffusealpha,0;sleep,33;linear,0.2;diffusealpha,1;sleep,4;linear,0.2;diffusealpha,0;);
	};

	LoadActor( "missmessage" )..{
		OnCommand=cmd(horizalign,left;diffusealpha,0;sleep,38;linear,0.2;diffusealpha,1;sleep,5;linear,0.2;diffusealpha,0;);
	};
};

t[#t+1] = LoadActor( THEME:GetPathB("ScreenDemonstration","overlay/demoback1") )..{
