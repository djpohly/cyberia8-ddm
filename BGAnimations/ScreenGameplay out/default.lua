...
if pm == 'PlayMode_Rave' then
	...
	t[#t+1] = Def.ActorFrame{
		...
		Def.Quad{
			...
			OnCommand=cmd(zoomtoheight,0;diffuse,color("0,0.5,0.5,0");fadebottom,0.4;sleep,1.9;
						accelerate,0.5;zoomtoheight,SCREEN_HEIGHT;diffuse,color("0,0.5,0.5,1");fadebottom,0;);
		};
