		...
		t[#t+1] = Def.ActorFrame{
			...
			LoadActor("_square_focus")..{
				...
				OnCommand=cmd(stoptweening;diffuse,color(basecolor());diffusealpha,0;sleep,sleepwait();decelerate,0.3;diffusealpha,0.8;
							linear,1;diffusealpha,0;sleep,6+(1-sleepwait());queuecommand,"Repeat";);
				RepeatCommand=cmd(stoptweening;diffuse,color(basecolor());diffusealpha,0;sleep,sleepwait();decelerate,0.3
								diffusealpha,0.8;linear,1;diffusealpha,0;sleep,6+(1-sleepwait());queuecommand,"Repeat";);
			};
		};
	end;
return t;
