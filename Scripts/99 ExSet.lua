...
function GetCCParameter(prm)
	local gpath;
	if FILEMAN:DoesFileExist("CSDataSave/0001_cc CSCountExt")  then
		gpath = "CSDataSave/0001_cc CSCountExt";
	else
		return "";
	end;
	local f = RageFileUtil.CreateRageFile();
...
function GetCFParameter(prm)
	local gpath;
	if FILEMAN:DoesFileExist("CSDataSave/0001_cf CSCheckExt")  then
		gpath = "CSDataSave/0001_cf CSCheckExt";
	else
		return "";
	end;
	local f = RageFileUtil.CreateRageFile();
